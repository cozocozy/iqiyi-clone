...
export const searchMovie = async (search) => {
  ...
  const movie = await axios.get(`https://api.themoviedb.org/3/search/movie?query=${search}&include_adult=false&language=en-US&page=1&api_key=91281c8e0736e34141a606ed71086f97`, { options });
  return movie.data.results;
};
