...
export const searchMovie = async (q) => {
  ...
  const movie = await axios.get(`https://api.themoviedb.org/3/search/movie?query=${q}&include_adult=false&language=en-&api_key=91281c8e0736e34141a606ed71086f97`, { options });
