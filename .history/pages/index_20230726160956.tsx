  ...
  return (
    <main>
      ...
      <section>
        ...
        <Swiper modules={[Navigation, Scrollbar, A11y]} spaceBetween={50} slidesPerView={3} navigation pagination={{ clickable: true }} scrollbar={{ draggable: true }} class="flex w-36 gap-3">
