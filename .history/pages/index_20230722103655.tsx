  ...
  return (
    <main>
      ...
      <section>
        ...
        <div className="flex flex-row ml-4 w-[9rem] h-[12rem] rounded rounded-md space-x-2">
          <img src="https://wallpapercave.com/wp/wp5709958.jpg" alt="" />
          <img src="https://wallpapercave.com/wp/wp5709958.jpg" alt="" />
        </div>
        <h2 className="flex flex-row max-w-sm text-xs items-center p-2 px-4 xl:text-3xl xl:mx-10 xl:my-4">hello world</h2>
      </section>
