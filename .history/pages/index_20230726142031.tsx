  ...
  return (
    <main>
      ...
      <section>
        ...
        <div className="flex space-x-5 overflow-x-scroll snap-x snap-mandatory scrollbar">
      ...
      <section>
        <div className="flex flex-row max-w-sm text-xl font-bold px-4 xl:text-3xl xl:mx-10 xl:my-4">Top Rated for you</div>
