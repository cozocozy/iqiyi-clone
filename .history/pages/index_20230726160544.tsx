  ...
  return (
    <main>
      ...
      <section>
        ...
        <Swiper modules={[Navigation]} slidesPerView={3} navigation onSwiper={(swiper) => console.log(swiper)} onSlideChange={() => console.log("slide change")} scrollbar={{ draggable: true }} class="flex w-36 gap-3">
