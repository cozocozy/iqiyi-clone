...
export default function Home() {
  return (
    <main className="mx-4 lg:mx-12 scroll-smooth bg-gray-950">
      <Head>
      ...
      <Slider />
      <section>
        <div id="#top" className="flex flex-row max-w-sm text-xl font-bold my-3 xl:text-3xl xl:my-4 select-none">
          Popular on iQIYI
        </div>
        <PopularMovies />
      </section>
      ...
      <Link href="#hero">
        <footer className="sticky bottom-5 w-full  cursor-pointer">
          <div className="flex justify-end items-center mr-3 lg:mr-5">
            <HiChevronUp className="z-100 h-12 w-12 bg-emerald-600 rounded-full cursor-pointer lg:h-14 lg:w-14 hover:bg-emerald-500 transition-all ease-in-out animate-bounce" />
          </div>
        </footer>
      </Link>
    </main>
