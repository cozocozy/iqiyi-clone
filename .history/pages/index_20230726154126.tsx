  ...
  return (
    <main>
      ...
      <section>
        ...
        <Swiper spaceBetween={50} slidesPerView={3} onSlideChange={() => console.log("slide change")} onSwiper={(swiper) => console.log(swiper)} class="flex h-26 w-40 gap-5 rounded-md">
