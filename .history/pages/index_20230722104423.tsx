...
export default function Home() {
  return (
    <main>
      ...
      <Slider />
      <section>
        <div className="flex flex-row max-w-sm text-xl font-bold p-2 px-4 xl:text-3xl xl:mx-10 xl:my-4 object-fit">Popular on iQIYI</div>
      ...
      <section>
        <div className="flex flex-row max-w-sm text-xl font-bold p-2 px-4 xl:text-3xl xl:mx-10 xl:my-4">Top Rated for you</div>
        <div className="flex flex-row ml-4 w-[9rem] h-[12rem] rounded rounded-md space-x-2 cursor-pointer">
          <img src="https://wallpapercave.com/wp/wp5709958.jpg" alt="" />
          <img src="https://wallpapercave.com/wp/wp5709958.jpg" alt="" />
        </div>
      ...
      <section>
        <div className="flex flex-row max-w-sm text-xl font-bold p-2 px-4 xl:text-3xl xl:mx-10 xl:my-4">Now Playing</div>
        <div className="flex flex-row ml-4 w-[9rem] h-[12rem] rounded rounded-md space-x-2 cursor-pointer">
          <img src="https://wallpapercave.com/wp/wp5709958.jpg" alt="" />
          <img src="https://wallpapercave.com/wp/wp5709958.jpg" alt="" />
        </div>
