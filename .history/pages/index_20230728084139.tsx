  ...
  return (
    <main>
      ...
      <section>
        ...
        <Swiper spaceBetween={10} slidesPerView={3} centeredSlides={false} navigation={true} modules={[Navigation]} className="flex w-full">
          {popularMovies.map((movies) => (
            // <MovieList key={movies.id} movies={movies} />
            <SwiperSlide>
              <img className="rounded-md gradient-mask-b-80 object-cover w-fill" src={`https://image.tmdb.org/t/p/w500/${movies.poster_path}`}></img>
