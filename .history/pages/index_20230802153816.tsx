    ...
    <main className="mx-4 lg:mx-12 scroll-smooth bg-gray-950">
      ...
      <footer className="sticky bottom-5 w-full  cursor-pointer">
        <div className="flex justify-end items-center mr-3 lg:mr-5">
          <HiChevronUp className="z-100 h-12 w-12 bg-emerald-500 rounded-full cursor-pointer lg:h-14 lg:w-14 hover:bg-emerald-700 transition-all ease-in-out animate-bounce" />
        </div>
      </footer>
    </main>
  );
