    ...
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      <div className="flex justify-between items-center py-1  lg:p-3 lg:ml-3 ">
        ...
        <div className="flex ml-4 mx-3">
          ...
          <button class="text-gray-400 hidden lg:ml-6 lg:flex z-20 lg:bg-zinc-600 hover:text-green-500 font-medium text-lg text-center items-center" type="button" onClick={() => setShow(!show)}>
            Browse
      ...
      {/* bottom part */}
      <div className={show ? "lg:hidden genre" : "genre lg:space-x-0 text-gray-300 md:justify-center md:items-center lg:flex-col lg:text-center lg:border lg:w-36 lg:ml-32 lg:space-y-2 lg:p-0 ease-out duration-300"}>
