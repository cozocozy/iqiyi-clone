    ...
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t h-[12rem]  border-gray-700 items-center lg:flex-row lg justify-start lg:h-[20rem] ">
          ...
          {/* icons */}
          <div className="flex justify-between w-[80%]  lg:w-[10%] lg:justify-end lg:flex-col lg:order-last lg:justify-end">
          ...
          {/* texts */}
          <div className="text-[9px] text-zinc-400 h-[6rem] space-y-2 flex flex-col w-[80%] justify-center lg:order-first sm:text-[10px] lg:text-[12px] lg:space-y-4  ">
        <div className="hidden lg:flex lg:capitalize lg:justify-center lg:space-x-24 lg:text-zinc-400 lg:text-sm lg:cursor-pointer">
          ...
          <div className="space-y-3 lg:mx-auto lg:mt-3">
