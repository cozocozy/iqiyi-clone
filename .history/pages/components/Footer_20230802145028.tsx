  ...
  return (
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t h-[12rem]  border-gray-700 items-center lg:h-[20rem] lg:pt-8 lg:order-last">
          <div className="flex justify-between w-[80%] lg:border lg:w-[10%] lg:right-[20%] lg:justify-end lg:flex-col  lg:justify-end">
