  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex flex-col bg-black w-full flex border-t border-gray-700 space-y-3 items-center h-[12rem]">
        ...
        <button className="border-full rounded-sm bg-zinc-800 p-1 w-[87%] h-8 flex items-center justify-center">
          <AiOutlineMobile className="mr-1" />
          Phone
        </button>
        <div className=" flex justify-evenly w-full h-8">
          <button className="border-full rounded-sm bg-zinc-800 w-[40%] flex items-center justify-center">
      ...
      <div className="text-[9px] text-zinc-400 h-[6rem] space-y-2 flex flex-col w-[23rem] mx-auto">
        <p>Copyright © 2021 iQiyi All Rights Reserved </p>
        <p>
          We use cookies to improve your experience on this site. By continuing to use our website, you agree to our use of cookies. Learn more <span className="underline hover:text-green-500">IQIYI Privacy Policy</span>
        </p>
      </div>
    </div>
  );
