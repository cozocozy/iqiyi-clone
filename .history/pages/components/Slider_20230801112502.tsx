  ...
  return (
    <div className="-mx-4 lg:-mx-12">
      <Swiper
        ...
        className="mySwiper w-full h-[20rem] mt-12 bg-gradient-to-t cursor-pointer from-white  to-zinc-900 bg-center object-cover opacity-80 lg:h-[50rem] lg:top-0 lg:-mt-1"
      >
