    ...
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t h-[12rem]  border-gray-700 items-center lg:h-[20rem] lg:pt-8 lg:border">
          ...
          <div className="text-[9px] text-zinc-400 h-[6rem] space-y-2 flex flex-col w-[80%] justify-center lg:items-start lg:border sm:text-[10px] lg:text-[12px] lg:space-y-4  ">
