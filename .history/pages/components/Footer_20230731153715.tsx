  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="text-[9px] text-zinc-400 h-[6rem] space-y-2 flex flex-col w-[23rem] mx-auto">
        ...
        <p>
          We use cookies to improve your experience on this site. By continuing to use our website, you agree to our use of cookies. Learn more <span className="">IQIYI Privacy Policy</span>
        </p>
      </div>
    </div>
  );
