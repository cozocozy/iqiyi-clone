...
function Header({}: Props) {
  return (
    <div className="fixed top-0 z-50 bg-black max-w-6xl">
      <div className="flex justify-evenly -space-x-2 mr-3 pt-1 items-center ">
        ...
        <div className="flex justify-center items-center">
          ...
          <input className="rounded rounded-md bg-neutral-700 w-72 h-7 pb-1 pl-3 max-w-6xl" placeholder="search here.."></input>
        </div>
