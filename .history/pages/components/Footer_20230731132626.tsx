...
function Footer({}: Props) {
  return (
    <div>
      <div className="flex flex-col bg-black w-full flex border-t border-gray-600 space-y-4 items-center h-[12rem]">
      ...
      <div className="flex flex-col bg-black w-full flex border-t border-gray-600 space-y-3 items-center h-[20rem]"></div>
    </div>
  );
}
