  ...
  return (
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t border-gray-700 justify-between lg:justify-center items-center">
          <div className="flex space-x-20 justify-around mx-auto">
          <div className="flex border rounded-md p-2 items-center h-8 text-xs cursor-pointer lg:w-[20%] ">
