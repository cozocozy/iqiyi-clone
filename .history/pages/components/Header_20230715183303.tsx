    ...
    <div className="sticky top-0 z-50 bg-black w-full">
      <div className="flex justify-evenly -space-x-2 mr-3 pt-1 items-center ">
        ...
        <div className="flex justify-center items-center">
          ...
          <input className="rounded rounded-md bg-neutral-700 w-72 h-8 pb-1 pl-3" placeholder="search here.."></input>
        </div>
        <button className="flex flex-row rounded rounded-md w-16 h-8 space-x-1 bg-green-500 text-gray-100 justify-evenly items-center p-2">
          <div className="">
      ...
      <div className="flex flex-row justify-around p-3 text-gray-300 ">
