    ...
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t h-[12rem]  border-gray-700 items-center lg:flex-row lg justify-start lg:h-[20rem] ">
          ...
          {/* icons */}
          <div className="flex justify-between w-[80%]  lg:w-1/3 lg:justify-end lg:flex-col lg:order-last lg:h-full lg:justify-center lg:items-center lg:space-y-16 xl:w-1/4">
