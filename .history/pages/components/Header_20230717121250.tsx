...
function Header({}: Props) {
  return (
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      ...
      <div className="flex flex-row  p-3 overflow-x-auto container-snap whitespace-nowrap space-x-4 ml-3 text-gray-300 md:justify-center md:items-center lg:flex-col lg:text-center lg:border lg:w-36 lg:ml-32 lg:space-y-2 lg:w-full lg:h-full ">
        <Link href="#" className="text-white pages lg:hover:text-green-500 hover:bg-gray-600">
          For You
        </Link>
        <Link href="#" className=" pages lg:hover:text-green-500 hover:bg-gray-600 ">
          Destined
        </Link>
        <Link href="#" className=" pages lg:hover:text-green-500 hover:bg-gray-600">
          Drama
        ...
        <Link href="#" className=" pages lg:hover:text-green-500hover:bg-gray-600">
          Anime
        </Link>
        <Link href="#" className=" pages browse lg:hover:text-green-500 hover:bg-gray-600">
          Variety Show
        </Link>
      </div>
    </div>
