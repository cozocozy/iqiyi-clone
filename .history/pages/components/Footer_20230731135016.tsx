...
function Footer({}: Props) {
  return (
    <div>
      ...
      <div className="flex bg-black w-full flex border-t border-gray-600 space-y-3 h-[20rem] justify-around">
        <div className="flex border rounded-md p-1 items-center h-10 text-sm">
