...
function Header({}: Props) {
  return (
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      <div className="flex justify-between items-center py-1 lg:p-3 lg:ml-3 ">
        ...
        <div className="flex ml-4 mx-3">
          ...
          <button
            ...
            class="text-white hidden lg:flex z-20 lg:bg-transparent hover:text-green-500 font-medium text-lg mx-8 text-center items-center"
            type="button"
          >
            Browse
      ...
      <div className="flex flex-row  p-3 overflow-x-auto container-snap whitespace-nowrap space-x-6 ml-3 text-gray-300 lg:flex-col lg:w-44 lg:text-center lg:ml-223 " id="dropdownHover">
