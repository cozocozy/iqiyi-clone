...
function Footer({}: Props) {
  return (
    <div>
      <div className="flex flex-col bg-black w-full flex border-t space-y-4 items-center h-[20rem]">
        <p className="text-white text-lg capitalize font-bold mt-2">get the best experience on the APP</p>
        <p className="text-xs">
          <span>IQIYI</span>
          Search in App Store
        </p>
