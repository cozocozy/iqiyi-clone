    ...
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t h-[12rem]  border-gray-700 items-center lg:flex-row lg:h-[20rem] ">
          ...
          {/* texts */}
          <div className="text-[9px] text-zinc-400 h-[6rem] space-y-2 flex flex-col w-2/3 justify-center lg:w-[100%] lg:order-first sm:text-[10px] lg:text-[12px] lg:space-y-6 xl:w-[80%] 2xl:w-[60%]  ">
