...
function Footer({}: Props) {
  return (
    <div>
      <div className="flex flex-col bg-black w-full flex border-t border-gray-600 space-y-3 items-center h-[20rem]">
        ...
        <p className="text-xs flex text-zinc-300">
          <span className="text-green-500 flex tracking-wide mr-1">
            <BsSearch className="mr-1" />
            IQIYI
          </span>
          Search in App Store
        </p>
        <button className="border-full rounded-sm bg-zinc-800 p-1 w-[84%] h-8 mt-3">Phone</button>
