    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex bg-black w-full border-t border-gray-700 h-[6rem] justify-between items-center p-2">
        ...
        <div className=" mr-7 cursor-pointer">
          <SocialIcon className="hover:-translate-y-1 hover:scale-110 transition ease-in-out delay-150" network="instagram" fgColor="white" bgColor="transparent" />
          <SocialIcon className="hover:-translate-y-1 hover:scale-110" network="facebook" fgColor="white" bgColor="transparent" />
          <SocialIcon className="hover:-translate-y-1 hover:scale-110" network="twitter" fgColor="white" bgColor="transparent" />
        </div>
      </div>
      <div className="text-[8px] text-zinc-400 h-[6rem] space-y-2 flex flex-col w-[23rem] mx-auto">
