    ...
    <>
      <div className=" mx-auto ">
        <div className="flex flex-col bg-black w-full flex border-t border-gray-700 space-y-3 lg:space-y-4 items-center h-[12rem]">
          ...
          <div className="w-full lg:flex space-y-4 lg:w-[18rem] lg:space-y-0 lg:pt-3 lg:justify-center ">
        ...
        <div className="flex bg-black w-full border-t border-gray-700 h-[6rem] lg:h-[15rem] justify-between lg:justify-center items-center">
          <div className="hidden lg:flex lg:capitalize lg:justify-center lg:space-x-10 lg:text-sm lg:text-zinc-400">
