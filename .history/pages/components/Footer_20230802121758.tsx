  ...
  return (
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t border-gray-700 h-[12rem] lg:h-[12rem] justify-between lg:justify-center items-center">
          
          <div className="flex flex-col border rounded-md p-2 items-center h-8 text-xs cursor-pointer ml-7 lg:w-[20%] ">
