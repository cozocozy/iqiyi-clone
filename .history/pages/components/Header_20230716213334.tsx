    ...
    <div className="fixed top-0 z-50 bg-black w-full">
      <div className="flex justify-between items-center py-1 lg:p-3 lg:ml-3 ">
        ...
        <div className="lg:flex lg:mt-2 lg:mr-6">
          ...
          {/* right part */}
          <button className="flex flex-row mr-8 mt-1 rounded rounded-md h-7 justify-center mx-3 bg-green-500 text-gray-100 items-center appBtn lg:bg-transparent lg:mx-2 lg:w-20">
