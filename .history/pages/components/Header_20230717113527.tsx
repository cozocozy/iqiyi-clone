...
function Header({}: Props) {
  return (
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      ...
      {/* bottom part */}
      <div className="lg:w-48 lg:flex lg:top-2  lg:top lg:flex-col lg:border lg:border-red-500 lg:items-center lg:justify-center lg:space-y-2">
        <button
        ...
        <div className="flex flex-row  p-3 overflow-x-auto container-snap whitespace-nowrap space-x-6 ml-3 text-gray-300 lg:flex-col lg:text-center " id="dropdownHover">
