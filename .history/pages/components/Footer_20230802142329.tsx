  ...
  return (
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t h-[12rem]  border-gray-700 lg:justify-center items-center lg:h-[30rem]">
          <div className="flex justify-between w-[80%]">
          <div className="flex border rounded-md p-2 items-center h-8 text-xs cursor-pointer">
