    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex bg-black w-full border-t border-gray-700 h-[6rem] justify-between items-center p-2">
        ...
        <div className=" mr-7 cursor-pointer">
          ...
          <SocialIcon className="hover:mb-3" network="facebook" fgColor="white" bgColor="transparent" />
          <SocialIcon className="hover:mb-3" network="twitter" fgColor="white" bgColor="transparent" />
        </div>
      </div>
