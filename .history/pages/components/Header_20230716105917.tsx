    ...
    <div className="fixed top-0 z-50 bg-black w-full">
      <div className="flex justify-between items-center py-1 ">
        ...
        <div className="flex justify-center items-center w-full mx-auto mt-1 rounded ">
          <input className="border-none rounded rounded-md bg-neutral-700 w-full max-w-2xl pl-3 pb-1 cursor-pointer" placeholder="search here.." autoComplete="off"></input>
          <button className="">
            <BsSearch />
          </button>
        </div>
