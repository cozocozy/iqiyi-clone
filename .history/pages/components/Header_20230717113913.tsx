...
function Header({}: Props) {
  return (
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      ...
      {/* bottom part */}
      <div className="lg:w-48 lg:absolute lg:top-2  lg:top lg:flex-col lg:border lg:border-red-500 lg:items-center lg:justify-center">
        <button
          id="dropdownHoverButton"
          data-dropdown-toggle="dropdownHover"
          data-dropdown-trigger="hover"
          class="text-gray-400 hidden lg:flex z-20 lg:bg-transparent hover:text-green-500 font-medium text-lg text-center items-center"
          type="button"
        >
          Browse
        ...
        <div className="flex flex-row  p-3 overflow-x-auto container-snap whitespace-nowrap space-x-6 ml-3 text-gray-300 md:justify-center md:items-center lg:flex-col lg:text-center " id="dropdownHover">
