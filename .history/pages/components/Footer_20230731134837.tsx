...
function Footer({}: Props) {
  return (
    <div>
      ...
      <div className="flex bg-black w-full flex border-t border-gray-600 space-y-3 h-[20rem]">
        <div className="flex border rounded-md p-1 items-center h-10">
          <CiGlobe className="mr-2 mt-1" />
