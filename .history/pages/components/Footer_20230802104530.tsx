    ...
    <>
      <div className="max-w-6xl mx-auto ">
        <div className="flex flex-col bg-black w-full flex border-t border-gray-700 space-y-3 items-center h-[12rem]">
          ...
          <div className="w-full lg:flex space-y-3">
            ...
            <div className=" flex justify-evenly w-full h-8">
              <button className="border-full rounded-sm bg-zinc-800 w-[30%] flex items-center justify-center  hover:bg-green-600 transition ease-in-out delay-100">
