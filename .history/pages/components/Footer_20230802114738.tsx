    ...
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex bg-black w-full border-t border-gray-700 h-[6rem] lg:h-[12rem] justify-between lg:justify-center items-center">
          <div className="hidden lg:flex lg:capitalize lg:justify-center lg:space-x-24 lg:text-zinc-400 lg:cursor-pointer">
            <div className="space-y-3 ">
              <p className="text-zinc-100 lg:cursor-default">About IQIYI</p>
              <p>about us</p>
