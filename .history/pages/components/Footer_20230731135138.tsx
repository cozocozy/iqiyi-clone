...
function Footer({}: Props) {
  return (
    <div>
      ...
      <div className="flex bg-black w-full flex border-t border-gray-600 space-y-3 h-[20rem] justify-around mt-2">
        <div className="flex border rounded-md p-2 items-center h-8 text-sm">
