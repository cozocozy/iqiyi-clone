...
function Header({}: Props) {
  ...
  return (
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      <div className="flex justify-between items-center py-2 lg:p-3 lg:ml-3 ">
        {/* left part */}
      ...
      {/* bottom part */}
      <div className="flex flex-row p-3 overflow-x-auto container-snap whitespace-nowrap space-x-4 ml-3 z-20 lg:space-x-0 text-gray-300 md:justify-center md:items-center lg:flex-col lg:text-center lg:border lg:w-36 lg:ml-32 lg:space-y-2 lg:p-0 ease-out duration-300">
