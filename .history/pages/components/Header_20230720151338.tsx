    ...
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      <div className="flex justify-between items-center py-1  lg:p-3 lg:ml-3 ">
        ...
        <div className="flex ml-4 mx-3">
          ...
          <button class="text-gray-400 hidden lg:ml-6 lg:flex z-20 lg:bg-zinc-900 hover:text-green-500 font-medium text-lg text-center items-center" type="button" onClick={() => setShow(!show)}>
            Browse
