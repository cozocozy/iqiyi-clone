    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex bg-black w-full flex border-t border-gray-600 space-y-3 h-6rem] justify-around p-2">
        ...
        <div className="space-x-1">
          <SocialIcon network="instagram" fgColor="gray" bgColor="transparent" style={{ height: 100, width: 30 }} />
          <SocialIcon network="facebook" fgColor="gray" bgColor="transparent" style={{ height: 25, width: 30 }} />
          <SocialIcon network="twitter" fgColor="gray" bgColor="transparent" style={{ height: 25, width: 30 }} />
        </div>
      </div>
