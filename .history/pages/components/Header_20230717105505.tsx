  ...
  return (
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      ...
      <button
        ...
        class="text-white hidden lg:sticky lg:bg-transparent hover:text-green-500 font-medium text-sm px-5 py-2.5 text-center inline-flex items-center"
        type="button"
      >
        Browse
      ...
      <div className="flex flex-row  p-3 overflow-x-auto container-snap whitespace-nowrap space-x-6 ml-3 text-gray-300 lg:flex-col lg:w-44 lg:text-center " id="dropdownHover">
        <Link href="#" className="text-white pages browse lg:ml-5 lg:hover:text-green-500 lg:hidden">
          For You
        </Link>
