    ...
    <div className="fixed top-0 z-50 bg-black w-full">
      <div className="flex justify-between items-center py-1 ">
        ...
        <div className="flex justify-center items-center mt-1 ">
          ...
          <input className="relative mx-auto z-1 rounded rounded-md bg-neutral-700 w-full pl-3 pb-1" placeholder="search here.." autoComplete="off"></input>
        </div>
        <button className="flex flex-row mr-7 mt-1 rounded rounded-md w-16 h-7 mx-3 bg-green-500 text-gray-100 justify-evenly items-center">
          <div className="ml-1">
