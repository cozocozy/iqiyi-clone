  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex flex-col bg-black w-full flex border-t border-gray-700 space-y-3 items-center h-[12rem]">
        ...
        <button className="border-full rounded-sm bg-zinc-800 p-1 w-[87%] h-8 flex items-center justify-center hover:bg-green-600 transition ease-in-out">
      ...
      <div className="hidden hover:absolute hover:bg-zinc-800 hover:border hover:rounded-sm hover:border-zinc-800 hover:p-5 hover:text-sm hover:ml-7">
