...
function Footer({}: Props) {
  return (
    <div>
      ...
      <p className="text-xs text-zinc-600">Copyright © 2021 iQiyi All Rights Reserved We use cookies to improve your experience on this site. By continuing to use our website, you agree to our use of cookies. Learn more </p>
    </div>
  );
}
