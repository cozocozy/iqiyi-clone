...
function Header({}: Props) {
  ...
  return (
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      ...
      <div
        className={
          show ? "lg:hidden genre" : "genre lg:space-x-0 text-gray-300 md:justify-center md:items-center lg:flex-col lg:text-center lg:border lg:border-gray-600 lg:bg-zinc-800 lg:w-36 lg:ml-32 lg:space-y-2 lg:p-0 ease-out duration-300"
        }
      >
