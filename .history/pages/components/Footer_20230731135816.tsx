  ...
  return (
    <div>
      ...
      <div className="flex bg-black w-full flex border-t border-gray-600 space-y-3 h-6rem] justify-around p-2">
        ...
        <div>
          <SocialIcon network="instagram" bgColor="transparent" color="#e3e3e3" />
          <SocialIcon network="facebook" bgColor="gray" fgcolor="gray" />
          <SocialIcon network="twitter" bgColor="gray" fgcolor="white" />
        </div>
      </div>
      <p className="text-xs text-zinc-600">Copyright © 2021 iQiyi All Rights Reserved </p>
      <p className="text-xs text-zinc-600 h-full">We use cookies to improve your experience on this site. By continuing to use our website, you agree to our use of cookies. Learn more</p>
    </div>
  );
}
