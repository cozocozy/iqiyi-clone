    ...
    <div className="fixed top-0 z-50 bg-black w-full">
      <div className="flex justify-between items-center py-1 ">
        ...
        <div className="flex ml-4 mx-3">
          ...
          <h3 className="text-2xl text-green-500 font-bold ml-2 lg:text-4xl">IQIYI</h3>
          <div className="hidden md:flex text-2xl xl:hidden">Browse</div>
        </div>

        {/* middle part */}
        <div className="relative flex justify-end items-center w-full mx-auto mt-1 lg:justify-end lg:max-w-sm lg:items-end ">
          <input className="border-none rounded rounded-md bg-neutral-700 w-full pl-3 pb-1 focus:outline-none lg:w-200" placeholder="search here.." autoComplete="off"></input>
      ...
      {/* bottom part */}
      <div className="flex flex-row  p-3 overflow-x-auto container-snap whitespace-nowrap space-x-6 ml-3 text-gray-300 lg:hidden">
