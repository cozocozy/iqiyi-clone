    ...
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t h-[12rem]  border-gray-700 items-center lg:h-[20rem] lg:pt-8">
          <div className="flex justify-between w-[80%] lg:border lg:w-[10%] lg:right-[20%] lg:justify-end lg:flex-col lg:order-1">
          ...
          <div className="text-[9px] text-zinc-400 h-[6rem] space-y-2 flex flex-col w-[80%] justify-center lg:justify-start lg:items-start lg:order-1 lg:border sm:text-[10px] lg:text-[12px] lg:space-y-4 lg:w-1/2 ">
