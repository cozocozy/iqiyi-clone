...
function Footer({}: Props) {
  return (
    <div>
      ...
      <p className="text-xs text-zinc-600">We use cookies to improve your experience on this site. By continuing to use our website, you agree to our use of cookies. Learn more</p>
    </div>
  );
}
