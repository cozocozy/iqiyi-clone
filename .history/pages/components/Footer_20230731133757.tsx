...
function Footer({}: Props) {
  return (
    <div>
      ...
      <div className="flex bg-white w-full flex border-t border-gray-600 space-y-3 items-center h-[20rem]">
        <div>
          <SocialIcon network="instagram" bgColor="white" fgcolor="gray" />
        </div>
        <div>
