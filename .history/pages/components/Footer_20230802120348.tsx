    ...
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex bg-black w-full border-t border-gray-700 h-[6rem] lg:h-[12rem] justify-between lg:justify-center items-center">
          <div className="hidden lg:flex lg:capitalize lg:justify-center lg:space-x-28 lg:text-zinc-400 lg:text-sm lg:cursor-pointer lg:w-20">
          ...
          <div className="flex border rounded-md p-2 items-center h-8 text-xs cursor-pointer ml-7 lg:w-10 ">
