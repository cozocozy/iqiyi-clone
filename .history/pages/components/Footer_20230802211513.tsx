    ...
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t h-[12rem]  border-gray-700 items-center lg:flex-row lg:h-[20rem] ">
          ...
          <select className="flex border rounded-md p-2 items-center h-8 text-xs cursor-pointer mt-3 ml-7 bg-zinc-500">
          <option  selected>English <IoIosArrowDown className="m-2" /></option>
