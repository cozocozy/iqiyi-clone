  ...
  return (
    <div className="fixed top-0 z-50 bg-black w-full">
      <div className="flex justify-between items-center py-1 ">
        ...
        {/* middle part */}
        <div className="relative flex justify-end items-center w-full mx-auto mt-1">
          <input className="border-none rounded rounded-md bg-neutral-700 w-full pl-3 pb-1 focus:outline-none lg:justify-end lg:items-end" placeholder="search here.." autoComplete="off"></input>
