    ...
    <>
      <div className="max-w-6xl mx-auto ">
        <div className="flex flex-col bg-black w-full flex border-t border-gray-700 space-y-3 items-center h-[12rem]">
          ...
          <div className="w-full lg:flex space-y-4 lg:w-32">
            ...
            <div className=" flex justify-evenly w-full h-8 ">
              <button className="border-full rounded-sm bg-zinc-800 w-[37%] ml-3 flex items-center justify-center  hover:bg-green-600 transition ease-in-out delay-100">
                <PiTelevisionSimpleLight className="mr-1" />
                TV
              </button>
              <button className="border-full rounded-sm bg-zinc-800 w-[357%] mr-3 flex items-center justify-center  hover:bg-green-600 transition ease-in-out delay-100">
