  ...
  return (
    <div className="fixed top-0 left-0 z-50 bg-white h-full w-[50%] max-w-sm">
      ...
      <div className="h-full bg-zinc-900 text-lg space-y-8 pt-5">
        ...
        <div className="rounded rounded-md bg-white w-[70%] h-10 mx-auto text-white bg-gray-950 flex justify-center items-center text-sm font-semibold">Playstore</div>
