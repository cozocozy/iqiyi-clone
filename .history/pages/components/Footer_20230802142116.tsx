  ...
  return (
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t h-[12rem]  border-gray-700 lg:justify-center items-center">
          ...
          <div className=" cursor-pointer lg:w-[20%]">
          ...
          <div className="text-[9px] text-zinc-400 h-[6rem] space-y-2 flex flex-col w-[80%] justify-center sm:text-[10px] lg:text-[12px] lg:space-y-4 lg:space-x-4 ">
        <div className="hidden lg:flex lg:capitalize lg:justify-center lg:space-x-20 lg:text-zinc-400 lg:text-sm lg:cursor-pointer">
          ...
          <div className="space-y-3 border mx-auto">
