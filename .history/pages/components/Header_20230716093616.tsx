...
function Header({}: Props) {
  return (
    <div className="fixed top-0 z-50 bg-black w-full">
      <div className="flex justify-between -space-x-2 mr-3 pt-1 items-center ">
        <div className="flex justtify-evenly lg:hidden">
          <AiOutlineMenu size={20} />
          <h3 className="text-2xl mb-1 text-green-500 font-bold md:">IQIYI</h3>
        </div>
        <div className="flex justify-center items-center">
          <button className="absolute p-1 border-l border-gray-500 ml-56 pl-3">
            <BsSearch />
          </button>
          <input className="block rounded rounded-md bg-neutral-700 w-72 h-7 pb-1 pl-3" placeholder="search here.."></input>
        </div>
