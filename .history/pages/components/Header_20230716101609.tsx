  ...
  return (
    <div className="fixed top-0 z-50 bg-black w-full">
      <div className="flex justify-between items-center py-1 ">
        ...
        <div className="flex justify-center items-center mt-1 w-full bg-green-50 ">
          {/* <button className="absolute border-l border-gray-500 ml-60 p-1 px-4">
            <BsSearch />
          </button> */}
          <input className="rounded rounded-md bg-neutral-700  h-7 pl-3 pb-1" placeholder="search here.."></input>
        </div>
