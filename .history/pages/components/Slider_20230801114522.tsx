  ...
  return (
    <div className="-mx-4 lg:-mx-12">
      <Swiper
        ...
        className="mySwiper w-full h-[21rem] object-cover mt-12 bg-gradient-to-t cursor-pointer from-white  to-zinc-900 opacity-80 lg:h-[50rem] lg:w-full lg:top-0 lg:-mt-1"
      >
