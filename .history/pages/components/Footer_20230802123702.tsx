    ...
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t h-[12rem]  border-gray-700 lg:justify-center items-center">
          <div className="flex justify-between mt-3 w-[30rem] max-w-2xl border">
          <div className="flex border rounded-md p-2 items-center h-8 text-xs cursor-pointer mt-3 ml-11">
            <CiGlobe className="mr-2" />
            English <IoIosArrowDown className="m-1 mt-1" />
          </div>
          <div className=" cursor-pointer lg:w-[20%] mr-11">
