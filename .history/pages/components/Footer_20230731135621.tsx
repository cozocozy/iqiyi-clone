...
function Footer({}: Props) {
  return (
    <div>
      ...
      <div className="flex bg-black w-full flex border-t border-gray-600 space-y-3 h-[10rem] justify-around p-2">
      ...
      <p>Copyright © 2021 iQiyi All Rights Reserved We use cookies to improve your experience on this site. By continuing to use our website, you agree to our use of cookies. Learn more </p>
    </div>
  );
}
