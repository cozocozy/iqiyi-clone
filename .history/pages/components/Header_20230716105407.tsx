  ...
  return (
    <div className="fixed top-0 z-50 bg-black w-full">
      <div className="flex justify-between items-center py-1 ">
        ...
        {/* middle part */}
        <div className="flex justify-center items-center w-full mt-1 rounded bg-neutral-700 ">
          <input className="border-none rounded rounded-md  w-full max-w-2xl pl-3 pb-1" placeholder="search here.." autoComplete="off"></input>
          <button className="">
            <BsSearch />
          </button>
        </div>
