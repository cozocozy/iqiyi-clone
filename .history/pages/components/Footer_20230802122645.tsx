  ...
  return (
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex flex-col bg-black w-full border-t justify-evenly border-gray-700 lg:justify-center items-center">
          <div className="flex space-x-20 justify-between">
          <div className="flex border rounded-md p-2 items-center h-8 text-xs cursor-pointer mt-2">
