  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex flex-col bg-black w-full flex border-t border-gray-600 space-y-3 items-center h-[12rem]">
        ...
        <button className="border-full rounded-sm bg-zinc-800 p-1 w-[90%] h-8">Phone</button>
        <div className=" flex justify-around w-full h-8">
          <button className="border-full rounded-sm bg-zinc-800 w-[55%]">TV</button>
          <button className="border-full rounded-sm bg-zinc-800 w-[45%]">Web</button>
        </div>
      </div>
      <div className="flex bg-black w-full flex border-t border-gray-600 space-y-3 h-6rem] justify-around p-2">
        <div className="flex border rounded-md p-2 pt-1 items-center h-8 text-xs mt-4 mr-10 cursor-pointer">
          <CiGlobe className="mr-2" />
          English <IoIosArrowDown className="m-1 mt-1" />
        </div>
        <div className="space-x-1">
          <SocialIcon network="instagram" bgColor="gray" color="#gray" />
          <SocialIcon network="facebook" bgColor="gray" fgcolor="gray" />
          <SocialIcon network="twitter" bgColor="gray" fgcolor="white" />
        </div>
      </div>
      <div className="text-[8px] text-zinc-500 h-[5rem] space-y-2 flex flex-col justify-center">
