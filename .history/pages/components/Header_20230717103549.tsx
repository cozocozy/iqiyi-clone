  ...
  return (
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      ...
      <button
        ...
        class="text-white hidden lg:flex lg:bg-transparent lg:hover:text-green-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        type="button"
      >
        Dropdown hover{" "}
