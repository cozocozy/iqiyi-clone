  ...
  return (
    <div>
      <div className="flex flex-col bg-black w-full flex border-t space-y-3 items-center h-[20rem]">
        ...
        <div></div>
        <button className="border-full rounded-sm bg-zinc-800 p-1 w-[82%]">Phone</button>
        <div className=" space-x-5 flex justify-center border-red-500 border w-full ">
          <button className="border-full rounded-sm bg-zinc-800 w-[41%]">TV</button>
          <button className="border-full rounded-sm bg-zinc-800 w-[41%]">Web</button>
        </div>
      </div>
    </div>
  );
