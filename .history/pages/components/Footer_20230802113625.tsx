  ...
  return (
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex bg-black w-full border-t border-gray-700 h-[6rem] justify-between lg:justify-center items-center">
          <div className="hidden lg:flex lg:capitalize lg:justify-center lg:space-x-10 lg:text-sm lg:mt-4 lg:text-zinc-400">
            <div>
              <p className="text-gray-200">About IQIYI</p>
              <p>about us</p>
