    ...
    <>
      <div className=" mx-auto ">
        <div className="flex flex-col bg-black w-full flex border-t border-gray-700 space-y-3 lg:space-y-4 items-center h-[12rem] lg:h-[11rem]">
          ...
          <div className="w-full lg:flex space-y-4 lg:w-2/3 lg:space-y-0 lg:pt-3 lg:justify-center ">
        ...
        <div className="flex flex-col bg-black w-full border-t h-[12rem]  border-gray-700 items-center lg:h-[20rem] lg:pt-8">
          ...
          <div className="text-[9px] text-zinc-400 h-[6rem] space-y-2 flex flex-col w-[80%] justify-center lg:justify-start lg:items-start lg:border sm:text-[10px] lg:text-[12px] lg:space-y-4 lg:w-1/2 ">
