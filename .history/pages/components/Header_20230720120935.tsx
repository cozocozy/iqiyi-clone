    ...
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      <div className="flex justify-between items-center py-1  lg:p-3 lg:ml-3 ">
        ...
        <div className="flex ml-4 mx-3">
          <h3 className="text-2xl text-green-500 font-bold ml-6 lg:text-4xl lg:ml-4">IQIYI</h3>{" "}
      ...
      {/* bottom part */}
      <div className="flex flex-row p-3 overflow-x-auto container-snap whitespace-nowrap space-x-5 ml-2 z-20 lg:space-x-0 text-gray-300 md:justify-center md:items-center lg:flex-col lg:text-center lg:border lg:w-36 lg:ml-32 lg:space-y-2 lg:p-0 ease-out duration-300">
