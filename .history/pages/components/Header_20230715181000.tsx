    ...
    <div className="sticky top-0 z-50 bg-black w-full overflow-auto">
      <div className="flex justify-evenly pt-2 items-center ">
        ...
        <div className="flex justify-center items-center">
          ...
          <input className="rounded rounded-md bg-neutral-800 w-72 h-7 pb-1 pl-3" placeholder="search here.."></input>
        </div>
        <button className="flex flex-row rounded rounded-md w-16 h-8 bg-[rgb(28,199,3)] text-gray-100 justify-evenly items-center p-2">
          <div className="">
