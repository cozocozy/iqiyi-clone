...
function Header({}: Props) {
  return (
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      ...
      <div className="flex flex-row  p-3 overflow-x-auto container-snap whitespace-nowrap space-x-4 ml-3 text-gray-300 md:justify-center md:items-center lg:flex-col lg:text-center lg:justify-start ">
