...
function Header({}: Props) {
  return (
    <div className="fixed top-0 z-50 bg-black w-full">
      <div className="flex justify-between items-center py-1 lg:p-2 ">
        {/* left part */}
        ...
        <div className="flex">
          ...
          {/* right part */}
          <button className="flex flex-row mr-8 mt-1 rounded rounded-md h-7 justify-center mx-3 bg-green-500 text-gray-100 items-center lg:w-20 lg:h-10 lg:bg-transparent lg:border lg:border-white lg:hover:border-green-300">
            <div className="mx-2 mr-1">
              <BsArrowDownSquare size={14} />
            </div>
            <p className="text-sm mr-2">APP</p>
          </button>
          <div className="navbar lg:rounded lg:rounded-md lg:bg-orange-300 lg:w-20 lg:text-black lg:flex lg:flex-row lg:justify-center lg:items-center">
            <PiCrownSimpleFill size={20} />
            <h1 className="lg:text-md mx-1">VIP</h1>
          </div>
        </div>
      </div>
