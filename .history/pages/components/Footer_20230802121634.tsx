  ...
  return (
    <>
      <div className=" mx-auto ">
        ...
        <div className="flex bg-black w-full border-t border-gray-700 h-[12rem] lg:h-[12rem] justify-between lg:justify-center items-center">
          
          <div className="flex border rounded-md p-2 items-center h-8 text-xs cursor-pointer ml-7 lg:w-[20%] ">
            <CiGlobe className="mr-2" />
            English <IoIosArrowDown className="m-1 mt-1" />
          </div>
          <div className=" mr-7 cursor-pointer lg:w-[20%]">
          ...
          <div className="text-[9px] text-zinc-400 h-[6rem] space-y-2 flex flex-col w-[24.5rem] sm:w-[35rem] sm:text-[10px] ml-8 lg:flex-col-reverse">
