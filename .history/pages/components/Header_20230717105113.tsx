...
function Header({}: Props) {
  return (
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparent">
      ...
      <div className="flex flex-row  p-3 overflow-x-auto container-snap whitespace-nowrap space-x-6 ml-3 text-gray-300 lg:flex-col lg:w-44 lg:text-center lg:hover:text-green-500" id="dropdownHover">
        <Link href="#" className="text-white pages browse lg:ml-5">
          For You
        </Link>
