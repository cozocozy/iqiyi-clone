  ...
  return (
    <div className="-mx-4 lg:-mx-12">
      <Swiper
        ...
        className="mySwiper w-full ml-20 h-[20rem] mt-12 flex justify-center items-center bg-gradient-to-t cursor-pointer from-white  to-zinc-900 opacity-80 lg:h-[50rem] lg:top-0 lg:-mt-1"
      >
