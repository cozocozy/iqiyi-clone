    ...
    <div className="fixed top-0 z-50 bg-black w-full">
      <div className="flex justify-between items-center py-1 ">
        ...
        <div className="flex justify-center items-center w-full mt-1 ">
          <button className="absolute border-gray-500 ml-60 p-1 px-4">
            <BsSearch />
          </button>
        ...
        <button className="flex flex-row mr-8 p-2 mt-1 rounded rounded-md w-24 h-7 justify-between mx-3 bg-green-500 text-gray-100 items-center">
          <div className="">
