  ...
  return (
    <div className="fixed top-0 z-50 bg-black w-full lg:bg-transparant">
      ...
      <button
        ...
        class="text-white hidden bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 lg:sticky lg:top-2"
        type="button"
      >
        Dropdown hover{" "}
