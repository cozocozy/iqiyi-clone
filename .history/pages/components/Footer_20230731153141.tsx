...
import {HiOutlineComputerDesktop} rom "react-icons/hi";
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex flex-col bg-black w-full flex border-t border-gray-700 space-y-3 items-center h-[12rem]">
        ...
        <button className="border-full rounded-sm bg-zinc-800 p-1 w-[87%] h-8">
          <CiMobile4 />
          Phone
        </button>
        <div className=" flex justify-evenly w-full h-8">
          <button className="border-full rounded-sm bg-zinc-800 w-[40%]">
            <PiTelevisionSimpleLight />
            TV
          </button>
          <button className="border-full rounded-sm bg-zinc-800 w-[40%]"><HiOutlineComputerDesktop />Web</button>
        </div>
      </div>
