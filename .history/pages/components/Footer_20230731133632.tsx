...
function Footer({}: Props) {
  return (
    <div>
      ...
      <div className="flex bg-black w-full flex border-t border-gray-600 space-y-3 items-center h-[20rem]">
        <div>
          <SocialIcon network="instagram" bgColor="transparent" fgcolor="gray" />
        </div>
        <div>
          <SocialIcon network="facebook" bgColor="transparent" fgcolor="gray" />
        </div>
        <div>
          <SocialIcon network="twitter" bgColor="transparent" fgcolor="gray" />
        </div>
      </div>
    </div>
  );
