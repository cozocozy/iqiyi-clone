      ...
      <div className=" mx-auto ">
        <div className="flex flex-col bg-black w-full flex border-t border-gray-700 space-y-3 lg:space-y-4 items-center h-[12rem]">
          ...
          <div className="w-full lg:flex space-y-4 lg:w-[20rem] lg:space-y-0 lg:pt-3 lg:justify-center ">
            <button className="border-full rounded-sm bg-zinc-800 p-1 w-[80%] lg:w-[50%] lg:-ml-10 lg:mr-4 mx-auto  h-8 flex items-center justify-center hover:bg-green-600 transition ease-in-out">
