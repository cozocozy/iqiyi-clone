  ...
  return (
    <main>
      ...
      <section>
        ...
        {/* <Swiper spaceBetween={30} centeredSlides={false} navigation={true} modules={[Navigation]} className="flex gap-3 w-36 my-2 mySwiper"></Swiper> */}
        ...
        <Swiper
          ...
          className="mySwiper flex flex-row w-[10rem] h-20"
        >
          {popularMovies.map((movies, i) => (
            <MovieList key={movies.id} movies={movies} />
          ))}
