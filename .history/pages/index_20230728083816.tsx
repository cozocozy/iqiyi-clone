  ...
  return (
    <main>
      ...
      <section>
        ...
        <Swiper spaceBetween={10} slidesPerView={3} centeredSlides={false} navigation={true} modules={[Navigation]} className="flex w-full max-w-md md:max-w-lg lg:max-w-2xl">
